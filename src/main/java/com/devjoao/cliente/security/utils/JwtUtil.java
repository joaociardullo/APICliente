package com.devjoao.cliente.security.utils;
...
public class JwtUtil {
    ...
    public String obterToken(UsuarioJwtRequest usuarioJwtRequest) {
        return Jwts.builder().setSubject(usuarioJwtRequest.getEmail()).setExpiration(gerarDataExpiracao()).signWith(SignatureAlgorithm.HS512, secret).compact();
    }
